...
extension MeterShellStyle {
  static let superMechanical = MeterShellStyle(
    ...
    bodyGradientColors: ThemeColors.MeterShell.superDark,
    strokeOpacity: 0.08,
    strokeLineWidth: 1.2,
    shadowOpacity: 0.35,
    shadowRadius: 16,
  ...
  static let goldenEagle = MeterShellStyle(
    ...
    cornerRadiusRatio: 0.08,
    bodyGradientColors: ThemeColors.MeterShell.golden,
    strokeOpacity: 0.4,
    strokeLineWidth: 1.2,
    shadowOpacity: 0.35,
    shadowRadius: 16,
  ...
  static let brightDigital = MeterShellStyle(
    ...
    cornerRadiusRatio: 0.08,
    bodyGradientColors: ThemeColors.MeterShell.brightDigital,
    strokeOpacity: 0.08,
    strokeLineWidth: 1.2,
    shadowOpacity: 0.4,
    shadowRadius: 16,
  ...
  static let digital = MeterShellStyle(
    ...
    cornerRadiusRatio: 0.08,
    bodyGradientColors: ThemeColors.MeterShell.digital,
    strokeOpacity: 0.08,
    strokeLineWidth: 1,
    shadowOpacity: 0.4,
    shadowRadius: 14,
